...
const TeacherRaceDashboardPage = () => {
  ...
  if (!snapshot) return (
    <div className="dashboard-container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      <h1 className="join-title">INITIALIZING DASHBOARD...</h1>
    </div>
  );
    ...
    <div className="dashboard-container">
      ...
      {sseError && (
        <div className="overlay-blur dashboard-error" style={{ zIndex: 9999 }}>
          <h1 className="error-title" style={{ fontSize: '5rem', color: 'var(--danger)', margin: 0 }}>SYSTEM DISCONNECTED</h1>
          <p className="error-subtitle" style={{ fontSize: '2rem', color: 'var(--danger)' }}>RE-ESTABLISHING UPLINK...</p>
        </div>
      )}
      ...
      <div className="dashboard-footer">
        <div className="footer-status">
          ...
          {sseError ? "DISCONNECTED" : "LIVE / מחובר"}
